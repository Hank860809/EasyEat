<?php
require 'Order_ListView_Process.php'
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dt">
                                        <thead>
                                            <tr>
                                                ...
                                                <th <?php echo $HiddenColumn11;?>><?php echo $ColumnHeader11;?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            while ($row = sqlsrv_fetch_array($stmt_Order, SQLSRV_FETCH_ASSOC)): //修改變數
                                            ?>	
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php echo $HiddenColumn11;?>><?php echo $row[$Column11]; ?></td>
                                                    ...
                                                    <td <?php echo $HiddenColumn8;?>>&nbsp;&nbsp;
                                                        <a href="<?php echo $EditPage;?>?<?php echo $Column1;?>=<?php echo $row[$Column1];?>&<?php echo $Column9;?>=<?php echo $row[$Column9];?>&Edit='Y'"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo $DeletePage;?>?<?php echo $Column1;?>=<?php echo $row[$Column1];?>&<?php echo $Column9;?>=<?php echo $row[$Column9];?>"> <p class="fa fa-times-circle"></p></a>
                                                    </td>
                                                </tr>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-2"><br>
                                         <a href="<?php echo $AddPage;?>?<?php echo $Column9;?>=<?php echo $ShopID;?>&Add='Y'"> <p class="btn btn-primary">新增</p></a>

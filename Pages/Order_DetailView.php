<?php
require 'Order_DetailView_Process.php'
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>	
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php echo $HiddenColumn11;?>>&nbsp;&nbsp;
                                                        <a href="<?php echo $EditPage;?>?<?php echo $Column1;?>=<?php echo $row[$Column1];?>&<?php echo $Column14;?>=<?php echo $row[$Column14];?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-2"><br>
                                         <a href="<?php echo $BackPage;?>?<?php echo $Column12;?>=<?php echo $ShopID;?>"> <p class="btn">返回</p></a>
                                    </div>
                                </div>	
                            </div> <!-- panel-body -->
                        </div> <!-- panel -->

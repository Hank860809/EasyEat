<?php
require 'TagByShop_TagView_Process.php'
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dt">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            while ($row = sqlsrv_fetch_array($stmt_TagByShop, SQLSRV_FETCH_ASSOC)): //修改變數
                                            ?>	
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php echo $HiddenColumn8;?>>&nbsp;&nbsp;
                                                        <a href="<?php echo $EditPage;?>?<?php echo $Column1;?>=<?php echo $row[$Column1];?>&<?php echo $Column9;?>=<?php echo $row[$Column9];?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo $DeletePage;?>?<?php echo $Column1;?>=<?php echo $row[$Column1];?>&<?php echo $Column2;?>=<?php echo $row[$Column2];?>&<?php echo $Column9;?>=<?php echo $row[$Column9];?>"> <p class="fa fa-times-circle"></p></a>
                                                    </td>
                                                </tr>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-2"><br>
                                         <a href="<?php echo $AddPage;?>?<?php echo $Column9;?>=<?php echo $ShopID;?>"> <p class="btn btn-primary">新增</p></a>

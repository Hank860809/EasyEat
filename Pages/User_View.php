                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dt">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            while ($row = sqlsrv_fetch_array($stmt_User, SQLSRV_FETCH_ASSOC)):
                                            ?>	
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php echo $HiddenColumn8;?>>&nbsp;&nbsp;
                                                        ...
                                                        <?php if(!($row[$Column1] == 1 or $row[$Column1] == 2 or $row[$Column1] == 3 or $row[$Column1] == 4 or $row[$Column1] == 5 or $row[$Column1] == 6 or $row[$Column1] == 7)):?>     

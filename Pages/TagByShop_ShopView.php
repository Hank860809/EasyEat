<?php
require 'TagByShop_ShopView_Process.php'
?>
<!DOCTYPE html>
<html>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dt">
                                        <thead>
                                            <tr>
                                                ...
                                                <th <?php echo $HiddenColumn12;?>><?php echo $ColumnHeader12; ?></th>
                                                <th <?php echo $HiddenColumn13;?>><?php echo $ColumnHeader13; ?></th>
                                                <th <?php echo $HiddenColumn14;?>><?php echo $ColumnHeader14;?></th>
                                            </tr>
                                        </thead>
                                        <tbody>

                                            <?php
                                            while ($row = sqlsrv_fetch_array($stmt_Shop, SQLSRV_FETCH_ASSOC)): //修改變數
                                            ?>	
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td <?php echo $HiddenColumn12;?>><?php echo $row[$Column12]; ?></td>
                                                    <td <?php echo $HiddenColumn13;?>><?php echo $row[$Column13]; ?></td>
                                                    <td <?php echo $HiddenColumn14;?>>&nbsp;&nbsp;

<?php
require 'District_Edit_Process.php'
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <?php else:?> <!-- 修改 -->
                                                        <input class="form-control" name="<?php echo $Column2;?>" id="<?php echo $Column2;?>" required="required" value="<?php echo $DistrictName //修改變數?>">  
                                                    <?php endif;?>
                                                </div>
                                            </div>	
